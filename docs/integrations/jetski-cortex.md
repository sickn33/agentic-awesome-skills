...
description: "Use agentic-awesome-skills with Jetski/Cortex without hitting context-window overflow with 1,963+ skills."
---

# Jetski/Cortex + Gemini: safe integration with 1,963+ skills
...
With 1,963+ skills, this approach fills the context window before user messages are even added, causing truncation.
