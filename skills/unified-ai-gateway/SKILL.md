...
The current public project release is `v0.4.6`. The inspection procedure below
...
current `v0.4.6` command in the [project README](https://github.com/happy520ai/unified-ai-system#try-it-in-60-seconds).
