...
risk: critical
source: community
source_repo: beatra-ai/ai-media-generator-skill
source_type: official
date_added: "2026-09-18"
author: beatra-ai
tags: [ai-media, image-generation, video-generation, music-generation, tts, mcp, paid-api, beatra]
tools: [claude, codex, cursor, gemini]
license: "MIT-0"
license_source: "https://github.com/beatra-ai/ai-media-generator-skill/blob/69afbfe9fc5be318279656311225c09f7ae03f97/LICENSE"
---
...
```bash
python3 "$HOME/.claude/skills/beatra/scripts/mcp_client.py" verify
```
...
review directory, verify its digest against the matching tree in `beatra-ai/ai-media-generator-skill`
...
- **Network.** Authorization uses `api.beatra.ai`; every tool call and upload
  ...
  `https://beatra.ai/skills/beatra/install.json` and archives from
  `cdn.beatra.ai`.
...
- **Public social-data lookup.** The universal package can query public social data. Treat that as its own approval, separate from a paid render.
...
- [Source tree at the pinned commit](https://github.com/beatra-ai/ai-media-generator-skill/tree/69afbfe9fc5be318279656311225c09f7ae03f97/skills/beatra)
- [Product page](https://beatra.ai/skills)
