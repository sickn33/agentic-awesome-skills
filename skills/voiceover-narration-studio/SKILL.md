...
description: "Install and use the official AI Voiceover Generator package, pinned by digest, for paid hosted work on the Beatra service."
category: media
risk: critical
source: community
source_repo: beatra-ai/ai-voiceover-generator-skill
source_type: official
date_added: "2026-09-18"
author: beatra-ai
tags: [tts, voiceover, narration, mcp, paid-api, beatra]
tools: [claude, codex, cursor, gemini]
license: "MIT-0"
license_source: "https://github.com/beatra-ai/ai-voiceover-generator-skill/blob/0c44adfad72422e6619f72d0fa91d4bbefac9592/LICENSE"
---
...
Pick or reuse a voice, turn scripts into narration ready for editing, plan ordered long-form or multilingual audio, and create a reusable custom voice, from inside Claude Code, Codex, or OpenClaw. The work is produced on the hosted, paid Beatra service
(`mcp.beatra.ai`).
...
| --- | --- |
| Package | `voiceover-narration-studio` `0.1.9` |
| Archive | `https://cdn.beatra.ai/agent-packages/voiceover-narration-studio/v0.1.9/voiceover-narration-studio-skill-0.1.9.zip` |
| Archive SHA-256 | `d0a86cb9f3e2a364c48cb8e0a405f8dc7d7b7b9b59b711a5630960e8f2cb1445` |
| Source tree | [`beatra-ai/ai-voiceover-generator-skill@0c44adf`](https://github.com/beatra-ai/ai-voiceover-generator-skill/tree/0c44adfad72422e6619f72d0fa91d4bbefac9592/skills/voiceover-narration-studio) (full SHA `0c44adfad72422e6619f72d0fa91d4bbefac9592`) |
...
- Use when the user explicitly wants AI Voiceover Generator audio produced on Beatra and accepts that it is paid.
...
curl -fsSLO "https://cdn.beatra.ai/agent-packages/voiceover-narration-studio/v0.1.9/voiceover-narration-studio-skill-0.1.9.zip"
printf '%s  %s\n' \
  'd0a86cb9f3e2a364c48cb8e0a405f8dc7d7b7b9b59b711a5630960e8f2cb1445' \
  'voiceover-narration-studio-skill-0.1.9.zip' | shasum -a 256 -c -
```
...
```bash
unzip -l voiceover-narration-studio-skill-0.1.9.zip
unzip -q voiceover-narration-studio-skill-0.1.9.zip
find voiceover-narration-studio -type l -print            # expect no output
find voiceover-narration-studio -type f -perm -111 -print # expect no output
grep -n '"auto_update": True' voiceover-narration-studio/scripts/mcp_client.py
```
...
```bash
git clone --quiet --filter=blob:none --no-checkout https://github.com/beatra-ai/ai-voiceover-generator-skill.git src
git -C src checkout --quiet 0c44adfad72422e6619f72d0fa91d4bbefac9592 -- skills/voiceover-narration-studio
(cd voiceover-narration-studio && find . -type f | LC_ALL=C sort | xargs shasum -a 256) > archive.sha
(cd src/skills/voiceover-narration-studio && find . -type f | LC_ALL=C sort | xargs shasum -a 256) > tree.sha
...
```bash
dest="$HOME/.claude/skills/voiceover-narration-studio"
test ! -e "$dest" || { echo "destination exists; stop and ask the user"; exit 1; }
cp -R voiceover-narration-studio "$dest"
...
```bash
python3 "$HOME/.claude/skills/voiceover-narration-studio/scripts/mcp_client.py" verify
```
...
review directory, verify its digest against the matching tree in `beatra-ai/ai-voiceover-generator-skill`
...
- **Network.** Authorization uses `api.beatra.ai`; every tool call and upload
  ...
  `https://beatra.ai/skills/voiceover-narration-studio/install.json` and archives from
  `cdn.beatra.ai`.
...
- [Source tree at the pinned commit](https://github.com/beatra-ai/ai-voiceover-generator-skill/tree/0c44adfad72422e6619f72d0fa91d4bbefac9592/skills/voiceover-narration-studio)
- [Product page](https://beatra.ai/skills/voiceover-narration-studio)
