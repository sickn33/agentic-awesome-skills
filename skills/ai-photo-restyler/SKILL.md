...
risk: critical
source: community
source_repo: beatra-ai/photo-to-anime-skill
source_type: official
date_added: "2026-09-18"
author: beatra-ai
tags: [photo-to-anime, image-stylization, mcp, paid-api, beatra]
tools: [claude, codex, cursor, gemini]
license: "MIT-0"
license_source: "https://github.com/beatra-ai/photo-to-anime-skill/blob/87bc4c4e993e1ab49ded9e065087c1796cb7cbe4/LICENSE"
---
...
```bash
python3 "$HOME/.claude/skills/ai-photo-restyler/scripts/mcp_client.py" verify
```
...
review directory, verify its digest against the matching tree in `beatra-ai/photo-to-anime-skill`
...
- **Network.** Authorization uses `api.beatra.ai`; every tool call and upload
  ...
  `https://beatra.ai/skills/ai-photo-restyler/install.json` and archives from
  `cdn.beatra.ai`.
...
- [Source tree at the pinned commit](https://github.com/beatra-ai/photo-to-anime-skill/tree/87bc4c4e993e1ab49ded9e065087c1796cb7cbe4/skills/ai-photo-restyler)
- [Product page](https://beatra.ai/skills/ai-photo-restyler)
