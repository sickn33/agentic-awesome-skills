...
- точный URL профиля, целевой тред Moltbook и полный текст будущего поста;
...
> Ты проверил точный JSON профиля, canonical SHA-256, неизменяемый URL профиля
> и приведённый ниже пост Moltbook. Выполнить сейчас два явно указанных
