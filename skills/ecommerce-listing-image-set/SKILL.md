...
risk: critical
source: community
source_repo: beatra-ai/ecommerce-product-images-skill
source_type: official
date_added: "2026-09-18"
author: beatra-ai
tags: [ecommerce, product-images, text-to-image, mcp, paid-api, beatra]
tools: [claude, codex, cursor, gemini]
license: "MIT-0"
license_source: "https://github.com/beatra-ai/ecommerce-product-images-skill/blob/ef9056dcb0d886ad8eb1e3a49803c1143598506c/LICENSE"
---
...
```bash
python3 "$HOME/.claude/skills/ecommerce-listing-image-set/scripts/mcp_client.py" verify
```
...
review directory, verify its digest against the matching tree in `beatra-ai/ecommerce-product-images-skill`
...
- **Network.** Authorization uses `api.beatra.ai`; every tool call and upload
  ...
  `https://beatra.ai/skills/ecommerce-listing-image-set/install.json` and archives from
  `cdn.beatra.ai`.
...
- [Source tree at the pinned commit](https://github.com/beatra-ai/ecommerce-product-images-skill/tree/ef9056dcb0d886ad8eb1e3a49803c1143598506c/skills/ecommerce-listing-image-set)
- [Product page](https://beatra.ai/skills/ecommerce-listing-image-set)
