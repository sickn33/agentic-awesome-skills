...
risk: critical
source: community
source_repo: beatra-ai/multilingual-voiceover-skill
source_type: official
date_added: "2026-09-18"
author: beatra-ai
tags: [tts, multilingual, voiceover, mcp, paid-api, beatra]
tools: [claude, codex, cursor, gemini]
license: "MIT-0"
license_source: "https://github.com/beatra-ai/multilingual-voiceover-skill/blob/030ec84801fec544bc8be4e1d4ff7333bee7cf0d/LICENSE"
---
...
```bash
python3 "$HOME/.claude/skills/ai-multilingual-dubbing/scripts/mcp_client.py" verify
```
...
review directory, verify its digest against the matching tree in `beatra-ai/multilingual-voiceover-skill`
...
- **Network.** Authorization uses `api.beatra.ai`; every tool call and upload
  ...
  `https://beatra.ai/skills/ai-multilingual-dubbing/install.json` and archives from
  `cdn.beatra.ai`.
...
- [Source tree at the pinned commit](https://github.com/beatra-ai/multilingual-voiceover-skill/tree/030ec84801fec544bc8be4e1d4ff7333bee7cf0d/skills/ai-multilingual-dubbing)
- [Product page](https://beatra.ai/skills/ai-multilingual-dubbing)
