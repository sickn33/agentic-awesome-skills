...
This AAS-ready adaptation preserves the routing rules from the official OrkasVideoStudio `video-router` skill at upstream commit `dd4a0f40b2bc6c6b0fe6f2e732c9540ffffefe08`. It adds catalog metadata, examples, limitations, and an included copy of the upstream MIT license; it does not bundle or install the OrkasVideoStudio runtime.
