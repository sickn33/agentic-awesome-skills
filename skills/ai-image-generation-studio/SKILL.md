...
risk: critical
source: community
source_repo: beatra-ai/ai-image-generator-skill
source_type: official
date_added: "2026-09-18"
author: beatra-ai
tags: [image-generation, text-to-image, mcp, paid-api, beatra]
tools: [claude, codex, cursor, gemini]
license: "MIT-0"
license_source: "https://github.com/beatra-ai/ai-image-generator-skill/blob/13c7b9b2a2197fb91deb6a3a1466124db620c3d1/LICENSE"
---
...
```bash
python3 "$HOME/.claude/skills/ai-image-generation-studio/scripts/mcp_client.py" verify
```
...
review directory, verify its digest against the matching tree in `beatra-ai/ai-image-generator-skill`
...
- **Network.** Authorization uses `api.beatra.ai`; every tool call and upload
  ...
  `https://beatra.ai/skills/ai-image-generation-studio/install.json` and archives from
  `cdn.beatra.ai`.
...
- [Source tree at the pinned commit](https://github.com/beatra-ai/ai-image-generator-skill/tree/13c7b9b2a2197fb91deb6a3a1466124db620c3d1/skills/ai-image-generation-studio)
- [Product page](https://beatra.ai/skills/ai-image-generation-studio)
