...
### release_brief_template.md

Product Release Brief template intended for the Delivery Team:

- Synthesizes PRD to focus on user journeys and operational updates.
- Highlights configuration details, rule limitations, and FAQs.

### changelog_template.md

Changelog structure based on PRD requirements:

- Organizes changes into Added, Changed, Fixed, and Security & Infrastructure.
- Highlights specific workflow and system improvements.
