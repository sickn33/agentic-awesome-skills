...
# 🌌 Antigravity Awesome Skills: 1,684+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More
...
- **Broad coverage with real utility**: 1,684+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,684+ Skills](#browse-1684-skills)
...
**Antigravity Awesome Skills** (Release 13.2.0) is a large, installable skill library for AI coding assistants. It packages 1,684+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
