<!-- registry-sync: version=10.10.0; skills=1446; stars=36291; updated_at=2026-05-04T16:40:10+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,446+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,446+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,446+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,446+ Skills](#browse-1446-skills)
...
If you want a faster answer than "browse all 1,446+ skills", start with a tool-specific guide:
