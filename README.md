<!-- registry-sync: version=17.1.0; skills=2118; stars=46304; updated_at=2026-09-12T08:59:35+00:00 -->
...
**Current release: V17.1.0.** This release includes AAS Core for complete local catalog search, agent-owned selection, manifest validation, planning, and diagnosis. Apply and recovery remain experimental and outside the supported preview path.
...
**[Read the AAS Core preview guide →](https://github.com/sickn33/agentic-awesome-skills/blob/v17.1.0/docs/users/aas-core.md)**
...
Read the [AAS Core guide](https://github.com/sickn33/agentic-awesome-skills/blob/v17.1.0/docs/users/aas-core.md) for the exact trust boundaries, current preview status, Codex/Claude setup model, and CLI lifecycle.
...
- **Broad coverage with real utility**: 2,118+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 2,118+ Skills](#browse-2118-skills)
...
For AAS Core, follow the [preview guide](https://github.com/sickn33/agentic-awesome-skills/blob/v17.1.0/docs/users/aas-core.md) and use only a package release whose notes explicitly state that it includes Core. Release 14.6.0 predates Core; Core-capable releases begin with the 15.x line.
...
- For Core setup, trust boundaries, stack manifests, and preview status, use the [AAS Core guide](https://github.com/sickn33/agentic-awesome-skills/blob/v17.1.0/docs/users/aas-core.md).
