<!-- registry-sync: version=12.5.0; skills=1555; stars=40667; updated_at=2026-06-14T08:56:09+00:00 -->
...
**Antigravity Awesome Skills** (Release 12.5.0) is a large, installable skill library for AI coding assistants. It packages 1,555+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
