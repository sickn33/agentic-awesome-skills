...
- **[HostDeFi](https://hostdefi.com/api/v1/mcp)**: Hosted MCP server for token-safety checks — A+–F grades for Solana and 8 EVM chains, plus x402-paid analytics and an A2A agent card.
