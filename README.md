<!-- registry-sync: version=11.0.0; skills=1451; stars=36771; updated_at=2026-05-08T07:33:35+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,451+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,451+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
**Current release: V11.0.0.** Trusted by 37k+ GitHub stargazers, this repository combines official and community skill collections with bundles, workflows, installation paths, and docs that help you go from first install to daily use quickly.
...
- **Broad coverage with real utility**: 1,451+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,451+ Skills](#browse-1451-skills)
...
If you want a faster answer than "browse all 1,451+ skills", start with a tool-specific guide:
