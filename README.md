<!-- registry-sync: version=10.7.0; skills=1437; stars=35188; updated_at=2026-04-26T14:16:16+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,437+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,437+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,437+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,437+ Skills](#browse-1437-skills)
...
If you want a faster answer than "browse all 1,437+ skills", start with a tool-specific guide:
