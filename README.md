<!-- registry-sync: version=13.0.0; skills=1681; stars=41173; updated_at=2026-06-20T08:17:54+00:00 -->
...
**Antigravity Awesome Skills** (Release 13.0.0) is a large, installable skill library for AI coding assistants. It packages 1,681+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
