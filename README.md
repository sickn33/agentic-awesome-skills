<!-- registry-sync: version=12.7.0; skills=1595; stars=40876; updated_at=2026-06-16T14:48:27+00:00 -->
...
**Antigravity Awesome Skills** (Release 12.7.0) is a large, installable skill library for AI coding assistants. It packages 1,595+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
