<!-- registry-sync: version=14.5.0; skills=1964; stars=43325; updated_at=2026-07-15T17:16:56+00:00 -->
...
# 🌌 Agentic Awesome Skills: 1,964+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Autohand Code, Copilot & More

> **Installable GitHub library of 1,964+ agentic skills for Claude Code, Cursor, Codex CLI, Autohand Code, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,964+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,964+ Skills](#browse-1964-skills)
...
**Agentic Awesome Skills** (Release 14.5.0) is a large, installable skill library for AI coding assistants. It packages 1,964+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Autohand Code, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
...
- **[gooseworks-ai/goose-skills](https://github.com/gooseworks-ai/goose-skills)**: Source for the `competitor-ad-intelligence` skill - evidence-labeled research across public ad libraries, creative patterns, landing-page funnels, and strategic counter-plays (MIT).
