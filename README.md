<!-- registry-sync: version=13.6.1; skills=1894; stars=42129; updated_at=2026-07-01T11:43:01+00:00 -->
...
**Antigravity Awesome Skills** (Release 13.6.1) is a large, installable skill library for AI coding assistants. It packages 1,894+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
