<!-- registry-sync: version=12.6.0; skills=1569; stars=40795; updated_at=2026-06-15T17:49:46+00:00 -->
...
**Antigravity Awesome Skills** (Release 12.6.0) is a large, installable skill library for AI coding assistants. It packages 1,569+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
