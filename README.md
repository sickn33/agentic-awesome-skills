<!-- registry-sync: version=14.4.0; skills=1959; stars=43124; updated_at=2026-07-14T07:01:47+00:00 -->
...
# 🌌 Agentic Awesome Skills: 1,959+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Autohand Code, Copilot & More

> **Installable GitHub library of 1,959+ agentic skills for Claude Code, Cursor, Codex CLI, Autohand Code, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,959+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,959+ Skills](#browse-1959-skills)
...
**Agentic Awesome Skills** (Release 14.4.0) is a large, installable skill library for AI coding assistants. It packages 1,959+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Autohand Code, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
