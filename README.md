<!-- registry-sync: version=12.2.0; skills=1525; stars=39937; updated_at=2026-06-07T07:53:19+00:00 -->
...
**Current release: V12.2.0.** Trusted by 40k+ GitHub stargazers, this repository combines official and community skill collections with bundles, workflows, installation paths, and docs that help you go from first install to daily use quickly.
...
**Antigravity Awesome Skills** (Release 12.2.0) is a large, installable skill library for AI coding assistants. It packages 1,525+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
