<!-- registry-sync: version=13.10.0; skills=1901; stars=42335; updated_at=2026-07-04T15:00:26+00:00 -->
...
**Antigravity Awesome Skills** (Release 13.10.0) is a large, installable skill library for AI coding assistants. It packages 1,901+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Autohand Code, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
