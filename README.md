<!-- registry-sync: version=12.9.0; skills=1678; stars=41083; updated_at=2026-06-19T07:44:32+00:00 -->
...
- **Broad coverage with real utility**: 1,678+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,678+ Skills](#browse-1678-skills)
...
**Antigravity Awesome Skills** (Release 12.9.0) is a large, installable skill library for AI coding assistants. It packages 1,678+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
