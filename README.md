<!-- registry-sync: version=13.13.0; skills=1936; stars=42574; updated_at=2026-07-08T05:44:06+00:00 -->
...
**Agentic Awesome Skills** (Release 13.13.0) is a large, installable skill library for AI coding assistants. It packages 1,936+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Autohand Code, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
