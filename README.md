<!-- registry-sync: version=13.3.0; skills=1689; stars=41729; updated_at=2026-06-26T06:38:23+00:00 -->
[![Antigravity Awesome Skills hero](assets/aas-readme-hero.jpeg)](https://github.com/sickn33/antigravity-awesome-skills)

# 🌌 Antigravity Awesome Skills: 1,689+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More
...
- **Broad coverage with real utility**: 1,689+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,689+ Skills](#browse-1689-skills)
...
**Antigravity Awesome Skills** (Release 13.3.0) is a large, installable skill library for AI coding assistants. It packages 1,689+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
