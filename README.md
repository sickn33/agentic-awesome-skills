<!-- registry-sync: version=14.1.0; skills=1945; stars=42661; updated_at=2026-07-09T06:03:23+00:00 -->
...
# 🌌 Agentic Awesome Skills: 1,945+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Autohand Code, Copilot & More

> **Installable GitHub library of 1,945+ agentic skills for Claude Code, Cursor, Codex CLI, Autohand Code, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,945+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,945+ Skills](#browse-1945-skills)
...
**Agentic Awesome Skills** (Release 14.1.0) is a large, installable skill library for AI coding assistants. It packages 1,945+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Autohand Code, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
