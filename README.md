<!-- registry-sync: version=13.2.0; skills=1689; stars=41640; updated_at=2026-06-25T06:37:39+00:00 -->
...
**Antigravity Awesome Skills** (Release 13.2.0) is a large, installable skill library for AI coding assistants. It packages 1,689+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
