<!-- registry-sync: version=13.9.0; skills=1898; stars=42265; updated_at=2026-07-03T08:28:21+00:00 -->
...
**Antigravity Awesome Skills** (Release 13.9.0) is a large, installable skill library for AI coding assistants. It packages 1,898+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Autohand Code, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
