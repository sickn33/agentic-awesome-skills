<!-- registry-sync: version=15.0.0-rc.3; skills=1968; stars=43528; updated_at=2026-07-18T14:01:48+00:00 -->
...
**Current release: V15.0.0-rc.3.** This release includes AAS Core under the **Agent-First Preview** claim for local search, inspection, recommendation, manifest validation, planning, and diagnosis. Apply and recovery remain experimental and outside the supported preview path.
...
- [Browse 1,968+ Skills](#browse-1968-skills)
