<!-- registry-sync: version=11.6.0; skills=1469; stars=38442; updated_at=2026-05-23T11:46:16+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,469+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,469+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,469+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,469+ Skills](#browse-1469-skills)
...
If you want a faster answer than "browse all 1,469+ skills", start with a tool-specific guide:
