...
4. **Iterative Exploration**: If Vizcom is available and approved, iterate without uploading confidential designs or third-party material the user cannot share.
5. **Finalize**: Label AI-assisted output, preserve source/provenance notes, and present candidates for user approval before downstream use.

## Strict Rules

- **Optional External Service**: Do not claim or invoke Vizcom unless it is actually available and the user approves external processing.
...
- **Rights & Confidentiality**: Confirm authorization before uploading sketches, CAD screenshots, brand assets, or personal data; follow applicable license and retention terms.
